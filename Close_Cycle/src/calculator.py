...
#Metods
    ...
    def calc_ciclo_rankine_in_precal_close_water(self,p1, p2, p3, T6,nb,nt):
        p1 = p1*1000  # Presión a la salida del condensador en Pa
        p2 = p2*1000  # Presión a la salida de la segunda bomba en Pa
        p3 = p3*1000 
